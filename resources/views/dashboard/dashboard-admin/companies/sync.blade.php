{{-- resources/views/dashboard/dashboard-admin/companies/sync.blade.php --}}

@extends('layouts.master')

@section('title', 'Sinkronisasi Companies')
...
<div class="container-fluid">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                @else
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">{{ $health['needs_sync_count'] }} companies perlu di-sync</small>
                                    </div>
                                @endif
                            </div>
                        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        Klik tombol di bawah untuk menjalankan sinkronisasi manual companies. 
                        Proses ini akan mengambil data terbaru dari aplikasi ABSEN.
                    </p>
                    
                    <form action="{{ route('companies.sync.trigger') }}" method="POST" id="syncForm" onsubmit="return confirmSync()">
                        @csrf
                        ...
                        <div class="d-grid gap-2 d-md-flex">
                            ...
                            <a href="{{ route('companies.sync.dashboard') }}" class="btn btn-secondary btn-lg">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>Company yang tidak ada di API akan di-soft delete (jika tidak punya relasi)</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    {{-- ========================================== --}}
    {{-- SECTION BARU: COMPANIES LIST (DATATABLES) --}}
    {{-- ========================================== --}}
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="companiesTable" class="table table-hover table-bordered" style="width:100%">
...
function refreshStats() {
    fetch('{{ route("companies.sync.status") }}')
...
$(document).ready(function() {
    $('#companiesTable').DataTable({
        ...
        columns: [
            ...
            { data: 'company_name', name: 'company_name' , width: '130px'},
        ...
        language: {
            ...
            info: 'Menampilkan _START_ sampai _END_ dari _TOTAL_ companies',
            infoEmpty: 'Tidak ada data',
            infoFiltered: '(difilter dari _MAX_ total companies)',
            zeroRecords: 'Tidak ada data yang cocok',
            emptyTable: 'Tidak ada companies tersedia',
            paginate: {
                first: 'Pertama',
                last: 'Terakhir',
                next: 'Selanjutnya',
