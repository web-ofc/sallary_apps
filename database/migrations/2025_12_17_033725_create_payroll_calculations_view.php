...
return new class extends Migration
{
    ...
    SELECT
        ...
        -- ✅ BPJS Income perusahaan (sama, selalu masuk)
        (
        ...
        -- ✅ Total Penerimaan: BPJS pegawai hanya masuk kalau NETT
        (
            COALESCE(p.gaji_pokok, 0)
        ...
        -- Total Potongan (sama, tidak berubah)
        (
        ...
        -- ✅ Gaji Bersih: ikut total_penerimaan yang sudah difix
        (
            (
                COALESCE(p.gaji_pokok, 0)
                + COALESCE(p.monthly_kpi, 0)
