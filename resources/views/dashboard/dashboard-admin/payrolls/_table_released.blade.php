{{-- resources/views/dashboard/dashboard-admin/payrolls/_table_released.blade.php --}}
...
<div class="d-flex justify-content-between align-items-center mb-5">
    ...
    <div class="d-flex align-items-center gap-2">
        <button type="button" class="btn btn-sm btn-light-success" id="btnDownloadPdfSelected" style="display:none">
            ...
            Download Slip (<span id="selectedReleasedCountDownload">0</span>)
        </button>

        <button type="button" class="btn btn-sm btn-light-success" id="btnExportReleased">
            <i class="ki-outline ki-file-down fs-3"></i> Export Released
        </button>
         @auth
            @if(auth()->user()->id === 1)
