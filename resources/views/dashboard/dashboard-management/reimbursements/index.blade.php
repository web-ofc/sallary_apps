...
$(document).ready(function() {
    ...
    table = $('#manage-reimbursements-table').DataTable({
        ...
        columns: [
            ...
            { data: 'karyawan_info', name: 'karyawan_info',  className: 'px-1' },
            { data: 'company_info',  name: 'company_info',   className: 'px-1' },
            { data: 'periode_slip',  name: 'reimbursements.periode_slip', className: 'px-1' },
            { data: 'year_budget',   name: 'reimbursements.year_budget',  className: 'px-1' },
            { data: 'total_amount',  name: 'total_amount',   orderable: false, searchable: false, className: 'px-1' },
            { data: 'approver_info', name: 'approved_id',    searchable: false, orderable: false, className: 'px-1' },
            { data: 'created_by',    name: 'user_by_id',     searchable: false, orderable: false, className: 'px-1' },
            { data: 'approved_at',   name: 'reimbursements.approved_at',  searchable: false, className: 'px-1' },
            { data: 'created_at',    name: 'reimbursements.created_at',   className: 'px-1' },
            { data: 'status',        name: 'reimbursements.status',        searchable: false, className: 'px-1' },
