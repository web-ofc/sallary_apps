...
class PayrollImportController extends Controller
{
    ...
    // ✅ BPJS deduction (negatif, include manual)
    ...
    return [
        ...
        // ✅ tampil pph_21_deduction versi view rules (POSITIF)
        ...
        // Calculated (ikut view rules)
        'total_penerimaan' => $totalPenerimaan,
        'total_potongan' => $totalPotongan,   // negatif (biar konsisten sama view)
